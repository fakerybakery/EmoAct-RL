...
if __name__ == "__main__":
    ...
    training_args = GRPOConfig(
        ...
        num_generations=4,         # Reduced from 8 to lower memory pressure
        max_prompt_length=1024,
        max_completion_length=1500,  # Reduced from 2048
        temperature=0.8,
        bf16=True,
        use_vllm=True,
        vllm_mode="colocate",
        vllm_gpu_memory_utilization=0.25,  # Slightly increased
        vllm_max_model_length=1500,  # Match max_completion_length
